...
function opstore_custom_customize_register( $wp_customize ) {
  ...
  $default = opstore_get_default_theme_options();
   ...
   /* Bottom header============================================= */
    ...
    /* mini cart layout */
    $wp_customize->add_setting('opstore_minicart_layout',array(
         'default' => 'offcanvas',
         'capability' => 'edit_theme_options',
         'sanitize_callback' => 'opstore_sanitize_minicart_layout',
         )
    );
    $wp_customize->add_control( 'opstore_minicart_layout',
         array(
             'label'  => esc_html__( 'Minicart Layout', 'opstore' ),
             'section' => 'opstore_header_layouts_section',
             'type' => 'select',
             'choices' => array(
                'dropdown'  => esc_html__( 'Dropdown', 'opstore' ),
                'offcanvas'  => esc_html__( 'Off Canvas', 'opstore' ),
              ),
             'priority' => 11
         )
    );  
   ...
   $wp_customize->selective_refresh->add_partial( 'opstore_'.$social, array(
    ...
    $wp_customize->add_setting('opstore_banner_title_position',array(
         ...
         'capability' => 'edit_theme_options',
         'sanitize_callback' => 'opstore_sanitize_banner_position',
         )
    );
  ...
  *Breadcrumb Settings */
    ...
    */
    ...
    $wp_customize->add_section( 'opstore_woo_section', array(
        'title'           =>     esc_html__('Shop Settings', 'opstore'),
        'priority'         =>    39,
    ));
    ...
    $wp_customize->add_setting( 'opstore_stock_status', array(
      'default' => $default['opstore_show_hide_option'],
      'sanitize_callback' => 'opstore_sanitize_switch_option',
          ) );

    $wp_customize->add_control( new Opstore_Customize_Switch_Control( $wp_customize, 'opstore_stock_status',  array(
      'type'      => 'switch',                    
      'label'     => esc_html__( 'Enable / Disable Stock Status', 'opstore' ),
      'section'   => 'opstore_woo_section',
      'choices'   => array(
            'show'  => esc_html__( 'Enable', 'opstore' ),
            'hide'  => esc_html__( 'Disable', 'opstore' )
