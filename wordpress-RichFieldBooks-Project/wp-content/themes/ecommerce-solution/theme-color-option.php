<?php
	...
	$ecommerce_solution_custom_css .='.woocommerce span.onsale{';
		$ecommerce_solution_custom_css .='padding-top: '.esc_html($ecommerce_solution_woo_product_sale_top_bottom_padding).'px; padding-bottom: '.esc_html($ecommerce_solution_woo_product_sale_top_bottom_padding).'px; padding-left: '.esc_html($ecommerce_solution_woo_product_sale_left_right_padding).'px; padding-right: '.esc_html($ecommerce_solution_woo_product_sale_left_right_padding).'px; display:inline-block;';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_woo_product_sale_border_radius = get_theme_mod('ecommerce_solution_woo_product_sale_border_radius',0);
	$ecommerce_solution_custom_css .='.woocommerce span.onsale {';
		$ecommerce_solution_custom_css .='border-radius: '.esc_html($ecommerce_solution_woo_product_sale_border_radius).'px;';
	$ecommerce_solution_custom_css .='}';
